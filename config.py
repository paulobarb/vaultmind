...
NVIDIA_API_KEY = "nvapi-xxxxxxxxxx" # Your API KEY here
...
HISTORY_LIMIT     = 8            # Past messages to send for context
...
HOURS_BACK         = 24          # How many hours back to auto-detect notes
